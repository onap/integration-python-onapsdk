...
class Anchor(CpsElement):
    ...
    def get_node(self, xpath: str, include_descendants: bool = False, descendants: int = 0) -> Dict[Any, Any]:
        ...
        Args:
            ...
            include_descendants (bool, optional): (Only v1) Determines if descendants should be included in
                response. Defaults to False.
            descendants (int, optional): (Only v2) Determines the number of descendant levels that should be returned.
        ...
        return self.send_message_json(
            ...
            f"{self.url}/node?xpath={xpath}&include-descendants={include_descendants}&descendants={descendants}",
            auth=self.auth
        )
