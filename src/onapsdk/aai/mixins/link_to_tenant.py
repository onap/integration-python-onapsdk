...
class AaiResourceLinkToTenantMixin:  # pylint: disable=too-few-public-methods
    ...
    def link_to_tenant(self, tnant: "Tenant") -> None:
        ...
        """
        reltionship: Relationship = Relationship(
            related_to="tenant",
        ...
        self.add_relationship(reltionship)

    def delete_tenant(self, tnant: "Tenant") -> None:
        """Create a relationship with tenant resource.

        as few resources create same relationship with tenant

        Args:
            tenant (Tenant): Tenant object to create relationship with.

        """
        reltionshp: Relationship = Relationship(
            related_to="tenant",
            related_link=tnant.url,
            relationship_data=[
                {
        ...
        self.delete_relationship(reltionshp)
