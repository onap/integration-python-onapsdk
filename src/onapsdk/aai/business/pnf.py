...
class PnfInstance(Instance):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, # NOSONAR  # pylint: disable=too-many-arguments, too-many-locals
                 ...
                 pnf_id: Optional[str] = None,
                 equip_type: Optional[str] = None,
                 equip_vendor: Optional[str] = None,
                 equip_model: Optional[str] = None,
                 management_option: Optional[str] = None,
                 orchestration_status: Optional[str] = None,
                 ipaddress_v4_oam: Optional[str] = None,
                 sw_version: Optional[str] = None,
                 frame_id: Optional[str] = None,
                 serial_number: Optional[str] = None,
                 ipaddress_v4_loopback_0: Optional[str] = None,
                 ipaddress_v6_loopback_0: Optional[str] = None,
                 ipaddress_v4_aim: Optional[str] = None,
                 ipaddress_v6_aim: Optional[str] = None,
                 ipaddress_v6_oam: Optional[str] = None,
                 ...
                 pnf_ipv4_address: Optional[str] = None,
                 pnf_ipv6_address: Optional[str] = None) -> None:
